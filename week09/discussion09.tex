...
\begin{center}
  \begin{tabular}{|l|l|l|l|l|l|l|}
    ...
    \multirow{2}{*}{$S$} & \multirow{2}{*}{$(b)$} & \multirow{2}{*}{$R$} & BNLJ & \sol{None}     & \sol{$\bnlj{[S]}{[R]}$}               & \multirow{2}{*}{$\frac{0.5[R][S]}{100}$} \\\cline{4-6}
                         &                        &                      & SMJ  & \sol{$(b)$}    & \sol{$SC(0.5[R]) + [S] + 0.5[R]$}     & \\\hline
    \multirow{2}{*}{$S$} & \multirow{2}{*}{$(b)$} & \multirow{2}{*}{$T$} & BNLJ & \sol{None}     & \sol{$\bnlj{[S]}{[T]}$}               & \multirow{2}{*}{$\frac{0.1[S][T]}{100}$} \\\cline{4-6}
